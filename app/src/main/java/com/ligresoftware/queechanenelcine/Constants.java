...
public class Constants {
    ...
    //URL del webservice
    public static final String WEBSERVICE_URL = "https://cine-crystaltales.rhcloud.com"; //https://demo0064908.mockable.io
    ...
    public static final String PARCELABLE_PELICULA = "PARCELABLE_PELICULA";
